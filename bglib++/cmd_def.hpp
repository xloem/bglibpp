...
/**Reset device**/
#define ble_cmd_system_reset(boot_in_dfu) this->send_message (bglib::ble_cmd_system_reset_idx,boot_in_dfu)
/**Hello - command for testing**/
#define ble_cmd_system_hello() this->send_message (bglib::ble_cmd_system_hello_idx)
/**Get device bluetooth address**/
#define ble_cmd_system_address_get() this->send_message (bglib::ble_cmd_system_address_get_idx)
/**write register**/
#define ble_cmd_system_reg_write(address,value) this->send_message (bglib::ble_cmd_system_reg_write_idx,address,value)
/**read register**/
#define ble_cmd_system_reg_read(address) this->send_message (bglib::ble_cmd_system_reg_read_idx,address)
/**get and reset packet counters**/
#define ble_cmd_system_get_counters() this->send_message (bglib::ble_cmd_system_get_counters_idx)
/**Get status from all connections**/
#define ble_cmd_system_get_connections() this->send_message (bglib::ble_cmd_system_get_connections_idx)
/**Read Memory**/
#define ble_cmd_system_read_memory(address,length) this->send_message (bglib::ble_cmd_system_read_memory_idx,address,length)
/**Get Device info**/
#define ble_cmd_system_get_info() this->send_message (bglib::ble_cmd_system_get_info_idx)
/**Send data to endpoint, error is returned if endpoint does not have enough space**/
#define ble_cmd_system_endpoint_tx(endpoint,data_len,data_data) this->send_message (bglib::ble_cmd_system_endpoint_tx_idx,endpoint,data_len,data_data)
/**Add entry to whitelist**/
#define ble_cmd_system_whitelist_append(address,address_type) this->send_message (bglib::ble_cmd_system_whitelist_append_idx,address,address_type)
/**Remove entry from whitelist**/
#define ble_cmd_system_whitelist_remove(address,address_type) this->send_message (bglib::ble_cmd_system_whitelist_remove_idx,address,address_type)
/**Add entry to whitelist**/
#define ble_cmd_system_whitelist_clear() this->send_message (bglib::ble_cmd_system_whitelist_clear_idx)
/**Read data from endpoint, error is returned if endpoint does not have enough data.**/
#define ble_cmd_system_endpoint_rx(endpoint,size) this->send_message (bglib::ble_cmd_system_endpoint_rx_idx,endpoint,size)
/**Set watermarks on both input and output side**/
#define ble_cmd_system_endpoint_set_watermarks(endpoint,rx,tx) this->send_message (bglib::ble_cmd_system_endpoint_set_watermarks_idx,endpoint,rx,tx)
/**Set encryption key that will be used with aes_encrypt and aes_decrypt commands.**/
#define ble_cmd_system_aes_setkey(key_len,key_data) this->send_message (bglib::ble_cmd_system_aes_setkey_idx,key_len,key_data)
/**Encrypt one block of data**/
#define ble_cmd_system_aes_encrypt(data_len,data_data) this->send_message (bglib::ble_cmd_system_aes_encrypt_idx,data_len,data_data)
/**Decrypt one block of data**/
#define ble_cmd_system_aes_decrypt(data_len,data_data) this->send_message (bglib::ble_cmd_system_aes_decrypt_idx,data_len,data_data)
/**Defragment persistent store**/
#define ble_cmd_flash_ps_defrag() this->send_message (bglib::ble_cmd_flash_ps_defrag_idx)
/**Dump all ps keys**/
#define ble_cmd_flash_ps_dump() this->send_message (bglib::ble_cmd_flash_ps_dump_idx)
/**erase all ps keys**/
#define ble_cmd_flash_ps_erase_all() this->send_message (bglib::ble_cmd_flash_ps_erase_all_idx)
/**save ps key**/
#define ble_cmd_flash_ps_save(key,value_len,value_data) this->send_message (bglib::ble_cmd_flash_ps_save_idx,key,value_len,value_data)
/**load ps key**/
#define ble_cmd_flash_ps_load(key) this->send_message (bglib::ble_cmd_flash_ps_load_idx,key)
/**erase ps key**/
#define ble_cmd_flash_ps_erase(key) this->send_message (bglib::ble_cmd_flash_ps_erase_idx,key)
/**erase flash page**/
#define ble_cmd_flash_erase_page(page) this->send_message (bglib::ble_cmd_flash_erase_page_idx,page)
/**write data to user data area**/
#define ble_cmd_flash_write_data(address,data_len,data_data) this->send_message (bglib::ble_cmd_flash_write_data_idx,address,data_len,data_data)
/**read data from user data area.**/
#define ble_cmd_flash_read_data(address,length) this->send_message (bglib::ble_cmd_flash_read_data_idx,address,length)
/**Write to attribute database**/
#define ble_cmd_attributes_write(handle,offset,value_len,value_data) this->send_message (bglib::ble_cmd_attributes_write_idx,handle,offset,value_len,value_data)
/**Read from attribute database**/
#define ble_cmd_attributes_read(handle,offset) this->send_message (bglib::ble_cmd_attributes_read_idx,handle,offset)
/**Read attribute type from database**/
#define ble_cmd_attributes_read_type(handle) this->send_message (bglib::ble_cmd_attributes_read_type_idx,handle)
/**Respond to user attribute read request**/
#define ble_cmd_attributes_user_read_response(connection,att_error,value_len,value_data) this->send_message (bglib::ble_cmd_attributes_user_read_response_idx,connection,att_error,value_len,value_data)
/**Response to attribute_changed event where reason is user-attribute write.**/
#define ble_cmd_attributes_user_write_response(connection,att_error) this->send_message (bglib::ble_cmd_attributes_user_write_response_idx,connection,att_error)
/**Send notification or indication to remote device.**/
#define ble_cmd_attributes_send(connection,handle,value_len,value_data) this->send_message (bglib::ble_cmd_attributes_send_idx,connection,handle,value_len,value_data)
/**Disconnect connection, starts a disconnection procedure on connection**/
#define ble_cmd_connection_disconnect(connection) this->send_message (bglib::ble_cmd_connection_disconnect_idx,connection)
/**Get Link RSSI**/
#define ble_cmd_connection_get_rssi(connection) this->send_message (bglib::ble_cmd_connection_get_rssi_idx,connection)
/**Update connection parameters**/
#define ble_cmd_connection_update(connection,interval_min,interval_max,latency,timeout) this->send_message (bglib::ble_cmd_connection_update_idx,connection,interval_min,interval_max,latency,timeout)
/**Request version exchange**/
#define ble_cmd_connection_version_update(connection) this->send_message (bglib::ble_cmd_connection_version_update_idx,connection)
/**Get Current channel map**/
#define ble_cmd_connection_channel_map_get(connection) this->send_message (bglib::ble_cmd_connection_channel_map_get_idx,connection)
/**Set Channel map**/
#define ble_cmd_connection_channel_map_set(connection,map_len,map_data) this->send_message (bglib::ble_cmd_connection_channel_map_set_idx,connection,map_len,map_data)
/**Remote feature request**/
#define ble_cmd_connection_features_get(connection) this->send_message (bglib::ble_cmd_connection_features_get_idx,connection)
/**Get Connection Status Parameters**/
#define ble_cmd_connection_get_status(connection) this->send_message (bglib::ble_cmd_connection_get_status_idx,connection)
/**Raw TX**/
#define ble_cmd_connection_raw_tx(connection,data_len,data_data) this->send_message (bglib::ble_cmd_connection_raw_tx_idx,connection,data_len,data_data)
/**Disable or enable slave latency**/
#define ble_cmd_connection_slave_latency_disable(disable) this->send_message (bglib::ble_cmd_connection_slave_latency_disable_idx,disable)
/**Discover attributes by type and value**/
#define ble_cmd_attclient_find_by_type_value(connection,start,end,uuid,value_len,value_data) this->send_message (bglib::ble_cmd_attclient_find_by_type_value_idx,connection,start,end,uuid,value_len,value_data)
/**Discover attributes by type and value**/
#define ble_cmd_attclient_read_by_group_type(connection,start,end,uuid_len,uuid_data) this->send_message (bglib::ble_cmd_attclient_read_by_group_type_idx,connection,start,end,uuid_len,uuid_data)
/**Read all attributes where type matches**/
#define ble_cmd_attclient_read_by_type(connection,start,end,uuid_len,uuid_data) this->send_message (bglib::ble_cmd_attclient_read_by_type_idx,connection,start,end,uuid_len,uuid_data)
/**Discover Attribute handle and type mappings**/
#define ble_cmd_attclient_find_information(connection,start,end) this->send_message (bglib::ble_cmd_attclient_find_information_idx,connection,start,end)
/**Read Characteristic value using handle**/
#define ble_cmd_attclient_read_by_handle(connection,chrhandle) this->send_message (bglib::ble_cmd_attclient_read_by_handle_idx,connection,chrhandle)
/**write data to attribute**/
#define ble_cmd_attclient_attribute_write(connection,atthandle,data_len,data_data) this->send_message (bglib::ble_cmd_attclient_attribute_write_idx,connection,atthandle,data_len,data_data)
/**write data to attribute using ATT write command**/
#define ble_cmd_attclient_write_command(connection,atthandle,data_len,data_data) this->send_message (bglib::ble_cmd_attclient_write_command_idx,connection,atthandle,data_len,data_data)
/**Send confirmation for received indication, use only if manual indications are enabled**/
#define ble_cmd_attclient_indicate_confirm(connection) this->send_message (bglib::ble_cmd_attclient_indicate_confirm_idx,connection)
/**Read Long Characteristic value**/
#define ble_cmd_attclient_read_long(connection,chrhandle) this->send_message (bglib::ble_cmd_attclient_read_long_idx,connection,chrhandle)
/**Send prepare write request to remote host**/
#define ble_cmd_attclient_prepare_write(connection,atthandle,offset,data_len,data_data) this->send_message (bglib::ble_cmd_attclient_prepare_write_idx,connection,atthandle,offset,data_len,data_data)
/**Send prepare write request to remote host**/
#define ble_cmd_attclient_execute_write(connection,commit) this->send_message (bglib::ble_cmd_attclient_execute_write_idx,connection,commit)
/**Read multiple attributes from server**/
#define ble_cmd_attclient_read_multiple(connection,handles_len,handles_data) this->send_message (bglib::ble_cmd_attclient_read_multiple_idx,connection,handles_len,handles_data)
/**Enable encryption on link**/
#define ble_cmd_sm_encrypt_start(handle,bonding) this->send_message (bglib::ble_cmd_sm_encrypt_start_idx,handle,bonding)
/**Set device to bondable mode**/
#define ble_cmd_sm_set_bondable_mode(bondable) this->send_message (bglib::ble_cmd_sm_set_bondable_mode_idx,bondable)
/**delete bonding information from ps store**/
#define ble_cmd_sm_delete_bonding(handle) this->send_message (bglib::ble_cmd_sm_delete_bonding_idx,handle)
/**set pairing requirements**/
#define ble_cmd_sm_set_parameters(mitm,min_key_size,io_capabilities) this->send_message (bglib::ble_cmd_sm_set_parameters_idx,mitm,min_key_size,io_capabilities)
/**Passkey entered**/
#define ble_cmd_sm_passkey_entry(handle,passkey) this->send_message (bglib::ble_cmd_sm_passkey_entry_idx,handle,passkey)
/**List all bonded devices**/
#define ble_cmd_sm_get_bonds() this->send_message (bglib::ble_cmd_sm_get_bonds_idx)
/**
		    Set out-of-band encryption data for device
		    Device does not allow any other kind of pairing except oob if oob data is set.
		    **/
#define ble_cmd_sm_set_oob_data(oob_len,oob_data) this->send_message (bglib::ble_cmd_sm_set_oob_data_idx,oob_len,oob_data)
/**
				...
				or being connected.
			**/
#define ble_cmd_sm_whitelist_bonds() this->send_message (bglib::ble_cmd_sm_whitelist_bonds_idx)
/**
				Change keys distribution fields in pairing request and response. By default all keys are distributed.
			**/
#define ble_cmd_sm_set_pairing_distribution_keys(initiator_keys,responder_keys) this->send_message (bglib::ble_cmd_sm_set_pairing_distribution_keys_idx,initiator_keys,responder_keys)
/**Set GAP central/peripheral privacy flags	
			**/
#define ble_cmd_gap_set_privacy_flags(peripheral_privacy,central_privacy) this->send_message (bglib::ble_cmd_gap_set_privacy_flags_idx,peripheral_privacy,central_privacy)
/**Set discoverable and connectable mode**/
#define ble_cmd_gap_set_mode(discover,connect) this->send_message (bglib::ble_cmd_gap_set_mode_idx,discover,connect)
/**start or stop discover procedure**/
#define ble_cmd_gap_discover(mode) this->send_message (bglib::ble_cmd_gap_discover_idx,mode)
/**Direct connection**/
#define ble_cmd_gap_connect_direct(address,addr_type,conn_interval_min,conn_interval_max,timeout,latency) this->send_message (bglib::ble_cmd_gap_connect_direct_idx,address,addr_type,conn_interval_min,conn_interval_max,timeout,latency)
/**End current GAP procedure**/
#define ble_cmd_gap_end_procedure() this->send_message (bglib::ble_cmd_gap_end_procedure_idx)
/**Connect to any device on whitelist**/
#define ble_cmd_gap_connect_selective(conn_interval_min,conn_interval_max,timeout,latency) this->send_message (bglib::ble_cmd_gap_connect_selective_idx,conn_interval_min,conn_interval_max,timeout,latency)
/**Set scan and advertising filtering parameters**/
#define ble_cmd_gap_set_filtering(scan_policy,adv_policy,scan_duplicate_filtering) this->send_message (bglib::ble_cmd_gap_set_filtering_idx,scan_policy,adv_policy,scan_duplicate_filtering)
/**Set scan parameters**/
#define ble_cmd_gap_set_scan_parameters(scan_interval,scan_window,active) this->send_message (bglib::ble_cmd_gap_set_scan_parameters_idx,scan_interval,scan_window,active)
/**Set advertising parameters**/
#define ble_cmd_gap_set_adv_parameters(adv_interval_min,adv_interval_max,adv_channels) this->send_message (bglib::ble_cmd_gap_set_adv_parameters_idx,adv_interval_min,adv_interval_max,adv_channels)
/**Set advertisement or scan response data. Use broadcast mode to advertise data**/
#define ble_cmd_gap_set_adv_data(set_scanrsp,adv_data_len,adv_data_data) this->send_message (bglib::ble_cmd_gap_set_adv_data_idx,set_scanrsp,adv_data_len,adv_data_data)
/**Sets device to Directed Connectable Mode
            ...
            **/
#define ble_cmd_gap_set_directed_connectable_mode(address,addr_type) this->send_message (bglib::ble_cmd_gap_set_directed_connectable_mode_idx,address,addr_type)
/**Set Initiating connection scan parameters**/
#define ble_cmd_gap_set_initiating_con_parameters(scan_interval,scan_window) this->send_message (bglib::ble_cmd_gap_set_initiating_con_parameters_idx,scan_interval,scan_window)
/**Set non-resolvable address**/
#define ble_cmd_gap_set_nonresolvable_address(address) this->send_message (bglib::ble_cmd_gap_set_nonresolvable_address_idx,address)
/**Configure I/O-port interrupts**/
#define ble_cmd_hardware_io_port_config_irq(port,enable_bits,falling_edge) this->send_message (bglib::ble_cmd_hardware_io_port_config_irq_idx,port,enable_bits,falling_edge)
/**Set soft timer to send events**/
#define ble_cmd_hardware_set_soft_timer(time,handle,single_shot) this->send_message (bglib::ble_cmd_hardware_set_soft_timer_idx,time,handle,single_shot)
/**Read A/D conversion**/
#define ble_cmd_hardware_adc_read(input,decimation,reference_selection) this->send_message (bglib::ble_cmd_hardware_adc_read_idx,input,decimation,reference_selection)
/**Configure I/O-port direction**/
#define ble_cmd_hardware_io_port_config_direction(port,direction) this->send_message (bglib::ble_cmd_hardware_io_port_config_direction_idx,port,direction)
/**Configure I/O-port function**/
#define ble_cmd_hardware_io_port_config_function(port,function) this->send_message (bglib::ble_cmd_hardware_io_port_config_function_idx,port,function)
/**Configure I/O-port pull-up/pull-down**/
#define ble_cmd_hardware_io_port_config_pull(port,tristate_mask,pull_up) this->send_message (bglib::ble_cmd_hardware_io_port_config_pull_idx,port,tristate_mask,pull_up)
/**Write I/O-port**/
#define ble_cmd_hardware_io_port_write(port,mask,data) this->send_message (bglib::ble_cmd_hardware_io_port_write_idx,port,mask,data)
/**Read I/O-port**/
#define ble_cmd_hardware_io_port_read(port,mask) this->send_message (bglib::ble_cmd_hardware_io_port_read_idx,port,mask)
/**Configure SPI**/
#define ble_cmd_hardware_spi_config(channel,polarity,phase,bit_order,baud_e,baud_m) this->send_message (bglib::ble_cmd_hardware_spi_config_idx,channel,polarity,phase,bit_order,baud_e,baud_m)
/**Transfer SPI data**/
#define ble_cmd_hardware_spi_transfer(channel,data_len,data_data) this->send_message (bglib::ble_cmd_hardware_spi_transfer_idx,channel,data_len,data_data)
/**Read data from I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up must be enabled on pins**/
#define ble_cmd_hardware_i2c_read(address,stop,length) this->send_message (bglib::ble_cmd_hardware_i2c_read_idx,address,stop,length)
/**Write data to I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up must be enabled on pins**/
#define ble_cmd_hardware_i2c_write(address,stop,data_len,data_data) this->send_message (bglib::ble_cmd_hardware_i2c_write_idx,address,stop,data_len,data_data)
/**Set TX Power**/
#define ble_cmd_hardware_set_txpower(power) this->send_message (bglib::ble_cmd_hardware_set_txpower_idx,power)
/**Set comparator for timer channel**/
#define ble_cmd_hardware_timer_comparator(timer,channel,mode,comparator_value) this->send_message (bglib::ble_cmd_hardware_timer_comparator_idx,timer,channel,mode,comparator_value)
/**Enable I/O-port interrupts**/
#define ble_cmd_hardware_io_port_irq_enable(port,enable_bits) this->send_message (bglib::ble_cmd_hardware_io_port_irq_enable_idx,port,enable_bits)
/**Set I/O-port interrupt direction**/
#define ble_cmd_hardware_io_port_irq_direction(port,falling_edge) this->send_message (bglib::ble_cmd_hardware_io_port_irq_direction_idx,port,falling_edge)
/**Enable or disable analog comparator**/
#define ble_cmd_hardware_analog_comparator_enable(enable) this->send_message (bglib::ble_cmd_hardware_analog_comparator_enable_idx,enable)
/**Read analog comparator output**/
#define ble_cmd_hardware_analog_comparator_read() this->send_message (bglib::ble_cmd_hardware_analog_comparator_read_idx)
/**Configure analog comparator interrupt**/
#define ble_cmd_hardware_analog_comparator_config_irq(enabled) this->send_message (bglib::ble_cmd_hardware_analog_comparator_config_irq_idx,enabled)
/**Set RX Sensitivity**/
#define ble_cmd_hardware_set_rxgain(gain) this->send_message (bglib::ble_cmd_hardware_set_rxgain_idx,gain)
/**Enable or disable USB**/
#define ble_cmd_hardware_usb_enable(enable) this->send_message (bglib::ble_cmd_hardware_usb_enable_idx,enable)
/**Enable or disable sleep mode**/
#define ble_cmd_hardware_sleep_enable(enable) this->send_message (bglib::ble_cmd_hardware_sleep_enable_idx,enable)
/**Start packet transmission, send one packet at every 625us**/
#define ble_cmd_test_phy_tx(channel,length,type) this->send_message (bglib::ble_cmd_test_phy_tx_idx,channel,length,type)
/**Start receive test**/
#define ble_cmd_test_phy_rx(channel) this->send_message (bglib::ble_cmd_test_phy_rx_idx,channel)
/**End test, and report received packets**/
#define ble_cmd_test_phy_end() this->send_message (bglib::ble_cmd_test_phy_end_idx)
/**Reset test**/
#define ble_cmd_test_phy_reset() this->send_message (bglib::ble_cmd_test_phy_reset_idx)
/**Get current channel quality map**/
#define ble_cmd_test_get_channel_map() this->send_message (bglib::ble_cmd_test_get_channel_map_idx)
/**Debug command**/
#define ble_cmd_test_debug(opcode,input_len,input_data) this->send_message (bglib::ble_cmd_test_debug_idx,opcode,input_len,input_data)
/**Set channel quality measurement mode**/
#define ble_cmd_test_channel_mode(mode) this->send_message (bglib::ble_cmd_test_channel_mode_idx,mode)
/**Reset system**/
#define ble_cmd_dfu_reset(dfu) this->send_message (bglib::ble_cmd_dfu_reset_idx,dfu)
/**set address for flashing**/
#define ble_cmd_dfu_flash_set_address(address) this->send_message (bglib::ble_cmd_dfu_flash_set_address_idx,address)
/**Upload binary for flashing. Address will be updated automatically.**/
#define ble_cmd_dfu_flash_upload(data_len,data_data) this->send_message (bglib::ble_cmd_dfu_flash_upload_idx,data_len,data_data)
/**Uploading is finished.**/
#define ble_cmd_dfu_flash_upload_finish() this->send_message (bglib::ble_cmd_dfu_flash_upload_finish_idx)
